...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2024 a las 00:24:58
...
--
-- RELACIONES PARA LA TABLA `carga_pago`:
--   `id_usuario`
--       `usuario` -> `Id_Usuario`
--   `id_metodoDePago`
--       `metodo_de_pago` -> `id_metodoDePago`
--   `id_alumno`
--       `alumno` -> `id_alumno`
--
...
--   `Id_Concepto`
--       `administracion` -> `Id_administracion`
--
...
--
-- RELACIONES PARA LA TABLA `metodo_de_pago`:
--
...
--
-- RELACIONES PARA LA TABLA `tipo_de_usuario`:
--
...
--   `id_tipodeusuario`
--       `tipo_de_usuario` -> `id_tipodeusuario`
--
...
--
-- Metadatos para la tabla carga_pago
--

--
-- Metadatos para la tabla carrera
--

--
-- Metadatos para la tabla concepto
--
...
--
-- Metadatos para la tabla metodo_de_pago
--

--
-- Metadatos para la tabla registros
--

--
-- Metadatos para la tabla tipo_de_usuario
--
